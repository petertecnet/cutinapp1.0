    ...
    public function resetPassword(Request $request)
    {
        try {
            $request->validate([
                ...
                'password' => 'required|string|min:8|confirmed', // Confirmação da senha
            ], $this->getValidationMessages());
            ...
            // Verifica se o código de redefinição de senha corresponde ao código armazenado no banco de dados
            ...
            // Limpa o código de redefinição de senha e o tempo de expiração
